...
function openwin6() { 
window.open ("index.php?page=guildes", "newwindow", "height=800, width=360, left:50%; margin:-181px 0 0 -170px; position:absolute; top:50%;z-index:102; toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no")  
} 
//--> ------------------------------------------------------------------------------------------------------------------------------------------- 
</script> 
</head> 
...
<table width="1251" height="1057" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
<tr>
...
<td rowspan="5">
	...
	<tr>
		<td rowspan="2"><a href="index.php?page=sg" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image57','','images/index2_18.gif',1)"><img src="images/index1_18.gif" name="Image57" width="91" height="37" border="0"></a></td>
<td>
...
<td>
	...
	<tr>
	  ...
	  <td colspan="13" rowspan="4" align="left" valign="top" background="images/index1_zz.gif">
	  <img src="images/index1_32.gif" width="1" height="1" alt="">
	  <div id="apDiv5">
	    <table width="0100%" border="0" cellspacing="0" cellpadding="00">
          <tr>
          ...
          <tr>
            <td height="36">&nbsp;</td>
            <td align="left" valign="bottom"><strong>[新闻公告]</strong></td>
          ...
          <tr>
            <td height="34">&nbsp;</td>
            <td align="left" valign="bottom"><strong>[新闻公告]</strong></td>
            <td align="left" valign="bottom"><span class="STYLE7">
              <?=($new2)?>
            </span></td>
          </tr>
          <tr>
	...
	<tr>
		<td rowspan="3" align="left" valign="top" background="images/index1_30.gif" background-position:center;><div id="apDiv7">
		  <table width="100%" height="222" border="0" cellpadding="00" cellspacing="0">
            ...
            <tr>
              <td height="35">&nbsp;</td>
              <td align="left" valign="bottom"><img src="images/lift1.gif" width="150" height="40"></td>
            </tr>
            <tr>
              <td rowspan="2" align="right" valign="bottom"><img src="images/2.gif" width="46" height="69"></td>
              <td height="47" align="left" valign="bottom"><img src="images/lift2.gif" width="150" height="40" border="0" usemap="#Map"></td>
            </tr>
            <tr>
              <td align="left" valign="bottom"><a href="#"onClick="openwin6()"><img src="images/lift3.gif" width="150" height="40" border="0"></td>
            </tr>
          </table>
		</div></td>
<td>
...
document.write(hello);
      ...
      <td height="284" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="00">
        <tr>
          <td height="280" align="left" valign="top" background="images/photo.gif"><div id="apDiv">
            <table width="100%" height="269" border="0" cellpadding="00" cellspacing="0">
              <tr>
                <td height="91" align="left" valign="bottom"><table width="100%" border="0" cellspacing="2" cellpadding="5">
                    <tr>
                      <td width="2%">&nbsp;</td>
                      <td width="98%"><span class="STYLE5">
                        <?=($say1)?>
                      </span></td>
                    </tr>
                    <tr>
              ...
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="00">
                    <tr>
                      <td><table width="98%" border="0" align="left" cellpadding="10" cellspacing="0">
                          <tr>
                            <td><marquee scrollamount="4" scrolldelay="5" valign="middle" behavior="scroll">
                              <img src="../star/1-XP.jpg" /> <img src="../star/2-HAO.jpg" /> <img src="../star/5-呗.jpg" /> <img src="../star/sb.jpg" /> <img src="../star/小賢的嫂子.jpg" width="150" height="150" /> <img src="../star/小爱.jpg" width="150" height="150" /> <img src="../star/糖糖.jpg" width="151" height="150" /> <img src="../star/smok.jpg" />
                            </marquee></td>
                          </tr>
                      </table></td>
                    </tr>
    ...
    <tr>
      ...
      <td width="74%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="00">
        <tr>
          <td height="280" align="left" valign="top" background="images/down.gif"><div id="apDiv20">
            <table width="100%" border="0" cellspacing="5" cellpadding="5">
              <tr>
                <td width="2%" height="68">&nbsp;</td>
                <td width="32%" align="left" valign="bottom"><span class="STYLE5">·提供游戏 登陆器 以及补丁下载 </span></td>
                <td width="66%" align="left" valign="bottom"><span class="STYLE9">079冒险岛客户端下载 [<strong><a href="http://games.qq.com/a/20100222/000313.htm" target="_self">请点击</a></strong>] 冒冒岛登陆器下载 [<strong onClick="MM_popupMsg('登录器周一下午16点16分准时发布')">请点击</a></strong>]</span></td>
              </tr>
              <tr>
                <td height="104">&nbsp;</td>
                <td colspan="2" rowspan="2" align="left" valign="top"><div id="apDiv22">
                  <table width="100%" height="179" border="0" cellpadding="0" cellspacing="10">
                    <tr>
                      <td align="left" valign="bottom"><strong>开服前三天价格如下：</strong><br>
                        本服VIP1[<strong>1</strong>块钱]<br>
                        本服VIP2[<strong>5</strong>块钱]<br>
                        本服VIP3[<strong>10</strong>块钱]<br>
                        本服VIP4[<strong>20</strong>块钱]<br>
                        <strong>后面的价格如下</strong>：<br>
                        本服VIP1[<strong>10</strong>块钱]VIP爆率增加到1.5<br>
                        本服VIP2[<strong>20</strong>块钱]VIP2经验增加到1.5<br>
                        本服VIP3[<strong>30</strong>块钱]VIP3两个都增加1.5<br>
                        本服VIP4[<strong>40</strong>块钱]VIP4全服点装免费！并且拥有以上条件<br>
                        本服VIP5[<strong>50</strong>块钱]VIP5所有爆率是本服经验以及爆率的两倍！并且全服所有点装免费</td>
                    </tr>
                  </table>
                </div></td>
                </tr>
...
<map name="Map"><area shape="rect" coords="5,7,142,38" href="index.php?page=paihang" target="_top">
</map>
</body>
</html>