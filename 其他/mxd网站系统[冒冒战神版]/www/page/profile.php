...
<div id="main">
  <table border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
   <form action="server.php" method="post" name="form" id="form">
    <tr>
      <td height="38" colspan="3" bgcolor="#FFFFCC">&nbsp;&nbsp;<strong>修改密码</strong></td>
    </tr>
    <tr>
      <td width="130" height="30" align="center" bgcolor="#FFFFFF">游戏帐号:</td>
      <td width="170" height="30" colspan="2" bgcolor="#FFFFFF"><input name="user" type="text" class="box" id="user" maxlength="12" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="30" colspan="3" bgcolor="#FFFFFF">修改密码说明。。。</td>
    </tr>
   </form>
  </table>
  <div id="footer"></div>
