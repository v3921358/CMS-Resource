...
<td>
	...
	<tr>
	  ...
	  <table id="__2" width="695" height="278" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="82" align="left" valign="top" background="../images/排行_01.gif"><div id="apDiv25">
            <table width="100%" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
                ...
                <td width="96%">此排行根据 <strong>力量大小</strong>排行 Top前50.</td>
              </tr>
            </table>
          </div></td>
        </tr>
        <tr>
          <td height="194" align="left" valign="top" background="../images/排行_02.gif"><div id="apDiv23">
            <table width="100%" border="0" cellspacing="0" cellpadding="00">
              <tr>
                <td height="784" align="left" valign="top"><div id="apDiv26">
                  <table width="100%" border="0" cellspacing="0" cellpadding="00">
                    <tr>
                      <td width="4%">&nbsp;</td>
                      <td width="96%"><table border="0" align="center" cellpadding="0" cellspacing="0">
                        <? $sql = mysql_query("SELECT * FROM characters ORDER BY str DESC LIMIT 0,50"); while ($data = mysql_fetch_array($sql)){ ?>
                        <? echo $data["rmbs"]; ?>
                        </span>
                        
                        <tr>
                          <td width="120" height="20"><strong><strong>名称:<? echo $data[name]; ?></td>
                          <td width="70" height="20"><strong><strong>等级:<? echo $data[level]; ?></td>
                          <td width="70" height="20"><strong><strong>力：<? echo $data[str]; ?></td>
                          <td width="70" height="20"><strong><strong>敏：<? echo $data[dex]; ?></td>
                          <td width="70" height="20"><strong><strong>智：<? echo $data[int]; ?></td>
                          <td width="70" height="20"><strong><strong>运：<? echo $data[luk]; ?></td>
                          <td width="92" height="20"><strong><strong>VIP等级:<? echo $data[vip]; ?></td>
                        </tr>
                        <? }?>
                      </table></td>
                    </tr>
	...
	<tr>
		<td rowspan="3" align="left" valign="top" background="images/index1_30.gif" background-position:center;><div id="apDiv7">
		  <table width="100%" height="222" border="0" cellpadding="00" cellspacing="0">
            ...
            <tr>
              <td align="left" valign="bottom"><a href="#"onClick="openwin6()"><img src="images/lift3.gif" width="150" height="40" onClick="MM_popupMsg('功能建设中')"></td>
            </tr>
          </table>
		</div></td>
<td>
